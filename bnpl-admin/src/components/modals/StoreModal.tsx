    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload: any = {
                ...
                commissionRate: formData.commissionRate === "" ? null : Number(formData.commissionRate),
                bankCommissionRate: formData.bankCommissionRate === "" ? null : Number(formData.bankCommissionRate),
                platformCommissionRate: formData.platformCommissionRate === "" ? null : Number(formData.platformCommissionRate),
